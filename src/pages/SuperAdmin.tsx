...
import { LogOut, ShieldCheck, Users, UserCheck, Crown, Plus, Pencil, Trash2, Loader2 } from "lucide-react";
    ...
    <div className="min-h-screen bg-[#0a0a0f] text-[#e0e0e0] flex">
      ...
      <aside className="w-56 bg-[#12121a] border-r border-[#1e1e2e] flex flex-col shrink-0">
        ...
        <nav className="flex-1 p-2">
          <div className="px-3 py-2 text-xs font-medium text-red-400/80 bg-red-500/10 rounded-md flex items-center gap-2">
